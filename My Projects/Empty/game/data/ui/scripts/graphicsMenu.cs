...
function GraphicsMenu::apply(%this)
{
   ...
   if($pref::PostFX::EnableSSAO != GraphicsMenuAO.isStateOn())
   {
      $pref::PostFX::EnableSSAO = GraphicsMenuAO.isStateOn();
      PostFXManager.settingsEffectSetEnabled("SSAO", $pref::PostFX::EnableSSAO);
   }
   
   if($pref::PostFX::EnableHDR != GraphicsMenuHDR.isStateOn())
   {
      $pref::PostFX::EnableHDR = GraphicsMenuHDR.isStateOn();
      PostFXManager.settingsEffectSetEnabled("HDR", $pref::PostFX::EnableHDR);
   }
   
   if($pref::PostFX::EnableDOF != GraphicsMenuDOF.isStateOn())
   {
      $pref::PostFX::EnableDOF = GraphicsMenuDOF.isStateOn();
      PostFXManager.settingsEffectSetEnabled("DOF", $pref::PostFX::EnableDOF);
   }
   
   if($pref::PostFX::EnableLightRays != GraphicsMenuLightRay.isStateOn())
   {
      $pref::PostFX::EnableLightRays = GraphicsMenuLightRay.isStateOn();
      PostFXManager.settingsEffectSetEnabled("LightRays", $pref::PostFX::EnableLightRays);
   }
   
   if($pref::PostFX::EnableVignette != GraphicsMenuVignette.isStateOn())
   {
      $pref::PostFX::EnableVignette = GraphicsMenuVignette.isStateOn();
      PostFXManager.settingsEffectSetEnabled("Vignette", $pref::PostFX::EnableVignette);
   }
